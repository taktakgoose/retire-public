/*
 * scenario.h — Personal scenario parameters.
 *
 * Edit these values to model your specific financial situation,
 * then recompile.  For tax rules and government-set amounts see
 * constants.h.
 */
...
/* Year of birth for each spouse. */
#define RALPH_YOB 1979
#define SARAH_YOB 1972
...
/* Buffer below the OAS clawback threshold — stop RRIF draws that would
